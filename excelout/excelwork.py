...
def get_ip_data():
    ...
    input_port = input("What port do you want it connected to? ")
    input_port = portValid(input_port)
    input_protocol = input("What protocol do you want to use [TCP or UDP]? ").upper()
    if input_protocol != "TCP" or input_protocol != "UDP":
        print("Invalid protocol, defaulting to TCP")
        input_protocol = "TCP"    
...
def portValid(port):
    try:
        ...
        print("Invalid port, defaulting to port 80")
        return 80
